...
class SeparateMDX(SeparateAttributes):
    ...
    def separate(self):
        ...
        background_stem_path = os.path.join(
            self.export_path, f'{self.audio_file_base}_background.wav')

        sf.write(primary_stem_path, vocals.T, samplerate,
                 subtype='PCM_16')
        
        sf.write(background_stem_path, background.T, samplerate, subtype='PCM_16')
        clear_gpu_cache()
